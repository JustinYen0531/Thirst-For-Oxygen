...
test('every successful formal weapon hit lowers the target Resonance value', () => {
  const state = createPlayCombatState();
  const actor = createTestActor({ x: 100, y: 100 });
  const target = enemy('resonance-hit', 'crabGuard', 140, 100);
  target.resonanceProgress = 12;
  target.resonanceRequired = 45;
