...
const VISUALS = {
  ...
  mutantNautilusOracle: { idle: gif('base-float-move-v3'), actions: { mutantCoralMortar: gif('attack-overloaded-relic-cast-v3'), mutantDualCoreMagic: gif('skill-360-core-scatter-cast-v3'), persistentCoreVolley: gif('skill-everlasting-core-cast-v3') } },
  mutantArcTideRay: { idle: gif('base-float-move-v3'), actions: { mutantWingRam: gif('attack-pressure-blade-aftershock-cast-v3'), mutantArcTideBombardment: gif('skill-secondary-pressure-burst-cast-v3') } },
};
