...
const VISUALS = {
  ...
  mutantNautilusOracle: { idle: gif('base-float-move-v3'), actions: { mutantCoralMortar: gif('attack-overloaded-relic-anchored-v2'), mutantDualCoreMagic: gif('skill-360-core-scatter-anchored-v2'), persistentCoreVolley: gif('skill-everlasting-core-anchored-v2') } },
  mutantArcTideRay: { idle: gif('base-float-move-v3'), actions: { mutantWingRam: gif('attack-pressure-blade-aftershock-anchored-v2'), mutantArcTideBombardment: gif('skill-secondary-pressure-burst-anchored-v2') } },
};
