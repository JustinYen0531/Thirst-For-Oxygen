...
const ENEMY_EN = Object.freeze({
  ...
  lionfishGunner: {
    ...
    attacks: {
      venomStraightShot: ['Venom Spine Shot', 'Fires one large, fast venomous spine that applies poison on hit and disappears when it strikes a wall.'],
      spineScatter: ['Spine Scatter', 'Alternates with Venom Spine Shot and fires five visibly smaller spines across a fan; these shots cannot pass through walls.'],
    },
  },
  squidAssassin: {
...
const MAP_EN = Object.freeze({
  ...
  coralCluster: ['Cell / Edge Object', 'Coral Colony', 'Approach and press E to become invisible to enemies for 2.5 seconds.', [['Placement', 'Legacy maps use a cell object; new layouts prefer edge attachment.'], ['Gameplay', 'A timed stealth rest point activated manually with E.']]],
  ...
  oxygenBubble: ['Cell Object', 'Clean Oxygen Bubble', 'A consumable bubble that immediately restores clean oxygen; Boss encounters periodically generate another one after the room activates.', [['Placement', 'Cell object, free-snap or centered'], ['Gameplay', 'Restores 25 O₂ without granting photosynthesis gravity immunity.']]],
  ...
  wallGillGate: ['Edge Interaction', 'Wall-Gill Gate', 'A living gate between water and rock. Approach and press E to enter or leave blocked terrain.', [['Placement', 'Water / blocked boundary edge'], ['Gameplay', 'Creates sparse wall routes; oxygen keeps draining and attacks are disabled inside rock.']]],
});
...
const UI_EN = Object.freeze({
  ...
  sections: { enemies: ['Enemies / Bosses', 'Creature reference, visual identity, and combat skill demonstrations.'], map: ['Map Elements', '31 placement entries and 29 unique elements, covering cells, gravity, water layers, and edges.'], weapons: ['Weapons', 'Roles, level changes, and build identity for four weapons.'], passives: ['Passive Abilities', 'Survival, resource, and damage directions across four passive lines.'], resonance: ['Resonance', 'How to neutralize enemies and collect permanent species buffs.'] },
...
const UI_ZH = Object.freeze({
  ...
  sections: { enemies: ['敵人／Boss', '生物原型、視覺識別與戰鬥技能演示。'], map: ['地圖元素', '31 種放置語彙、29 個唯一元素；從 Cell、重力、水域層到 Edge 的完整地圖語言。'], weapons: ['武器', '四把武器的定位、等級變化與建構角色。'], passives: ['被動能力', '四條能力線的生存、資源與輸出方向。'], resonance: ['Resonance 共鳴', '如何讓敵人中立，並取得永久物種 Buff。'] },
