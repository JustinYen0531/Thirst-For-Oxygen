...
const TRANSLATIONS = Object.freeze({
  ...
  'home.map.partTwo': Object.freeze({ en: 'Part Two | Crossing the Thermal Vents', 'zh-Hant': '第二部分｜穿越熱泉' }),
  'home.map.partThree': Object.freeze({ en: 'Part Three | Abyssal Ruins', 'zh-Hant': '第三部分｜深淵遺跡' }),
  'home.map.ascentPartOne': Object.freeze({ en: 'Part One | Reverse-Current Abyssal Ruins', 'zh-Hant': '第一部分｜逆游深海遺跡' }),
  'home.map.ascentPartTwo': Object.freeze({ en: 'Part Two | Reverse Passage Through the Vents', 'zh-Hant': '第二部分｜逆穿熱泉' }),
  'home.map.ascentPartThree': Object.freeze({ en: 'Part Three | Return to the Forest Exit', 'zh-Hant': '第三部分｜重返森林出口' }),
  'home.map.autoDive': Object.freeze({ en: 'Automatic descent', 'zh-Hant': '自動下潛' }),
  'home.map.resume': Object.freeze({ en: '▶ Resume tour', 'zh-Hant': '▶ 繼續巡覽' }),
  'home.map.pauseTour': Object.freeze({ en: 'Ⅱ Pause tour', 'zh-Hant': 'Ⅱ 暫停巡覽' }),
  'home.map.toCore': Object.freeze({ en: 'Continuing toward the Abyssal Core', 'zh-Hant': '向深淵核心持續下沉' }),
  'home.map.nextPart': Object.freeze({ en: 'Automatic descent · Next: Part {part}', 'zh-Hant': '自動下潛 · 下一段為第 {part} 部分' }),
  ...
  'home.loading.progressAria': Object.freeze({ en: 'Game asset loading progress', 'zh-Hant': '遊戲素材載入進度' }),
  'home.loading.ready': Object.freeze({ en: 'Descent ready', 'zh-Hant': '下潛準備完成' }),
  'home.loading.readyWithFallbacks': Object.freeze({ en: 'Ready with {count} fallback assets', 'zh-Hant': '準備完成，{count} 個素材將使用備援顯示' }),
  ...
  'home.settings.gameplay': Object.freeze({ en: 'Gameplay assistance', 'zh-Hant': '遊玩輔助' }),
  'home.settings.playerDamage': Object.freeze({ en: 'Player damage taken', 'zh-Hant': '玩家承受傷害' }),
  'home.settings.damageStandard': Object.freeze({ en: 'Standard (0% reduction)', 'zh-Hant': '標準（減傷 0%）' }),
  'home.settings.damage30': Object.freeze({ en: '30% reduction', 'zh-Hant': '減傷 30%' }),
  'home.settings.damage50': Object.freeze({ en: '50% reduction (Recommended)', 'zh-Hant': '減傷 50%（推薦）' }),
  'home.settings.damage75': Object.freeze({ en: '75% reduction', 'zh-Hant': '減傷 75%' }),
  'home.settings.damage90': Object.freeze({ en: '90% reduction', 'zh-Hant': '減傷 90%' }),
  'home.settings.resourceCost': Object.freeze({ en: 'Oxygen / energy cost reduction', 'zh-Hant': '氧氣／能量消耗減免' }),
  'home.settings.costStandard': Object.freeze({ en: 'Standard (0% reduction)', 'zh-Hant': '標準（減免 0%）' }),
  'home.settings.cost30': Object.freeze({ en: '30% reduction (Recommended)', 'zh-Hant': '減免 30%（推薦）' }),
  'home.settings.cost50': Object.freeze({ en: '50% reduction', 'zh-Hant': '減免 50%' }),
  'home.settings.cost75': Object.freeze({ en: '75% reduction', 'zh-Hant': '減免 75%' }),
  'home.settings.cost90': Object.freeze({ en: '90% reduction', 'zh-Hant': '減免 90%' }),
  'home.settings.gameplayHelp': Object.freeze({ en: 'These are the same survival assists used in formal play.', 'zh-Hant': '這些就是正式遊玩頁使用的相同生存輔助設定。' }),
  'home.settings.audio': Object.freeze({ en: 'Audio', 'zh-Hant': '音訊' }),
  'home.settings.ambientOn': Object.freeze({ en: '◉ Diving ambience: On', 'zh-Hant': '◉ 潛水環境音：開' }),
  'home.settings.ambientOff': Object.freeze({ en: '○ Diving ambience: Off', 'zh-Hant': '○ 潛水環境音：關' }),
  'home.settings.ambientVolume': Object.freeze({ en: 'Diving ambience volume', 'zh-Hant': '潛水環境音音量' }),
