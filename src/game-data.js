    ...
    levels: {
      ...
      2: {
        ...
        effect: {
          ...
          empoweredCoreColour: '#fff0f5',
          empoweredGlowColour: '#ff9eb8',
          empoweredLineWidth: 8,
          empoweredCoreLineWidth: 2.8,
      ...
      3: {
        ...
        effect: {
          ...
          empoweredCoreColour: '#fff0f5',
          empoweredGlowColour: '#ff9eb8',
          empoweredLineWidth: 8.8,
          empoweredCoreLineWidth: 3,
          empoweredDamageMultiplier: 2,
          empowerAfterMovement: true,
          wave: {
            style: 'katanaOuterArcWave',
            duration: 0.24,
            innerRadius: 24,
            radius: 76,
            arcDegrees: 96,
