...
const EXACT_ENGLISH = Object.freeze({
  ...
  '受到的所有傷害 -3%。': 'All incoming damage -3%.', '最大氧氣 +8%。': 'Maximum oxygen +8%.',
  '高氧高能時的生命恢復速度 +15%。': 'Health recovery at high oxygen and energy +15%.',
  '所有武器傷害 +6%。': 'All weapon damage +6%.', '武器傷害 +4%，武器能量消耗 -2%。': 'Weapon damage +4%; weapon energy cost -2%.',
  '氧氣倒數速度 -6%。': 'Oxygen countdown speed -6%.', '受到的傷害 -2%，生命恢復 +8%。': 'Incoming damage -2%; health recovery +8%.',
  '最大氧氣 +6%，氧氣倒數速度 -3%。': 'Maximum oxygen +6%; oxygen countdown speed -3%.',
  '彈射初速 +8%。': 'Launch speed +8%.', '彈射能量消耗 -6%。': 'Launch energy cost -6%.',
  '補充氧氣或能量時，額外恢復 4% 生命。': 'Recover 4% extra health when restoring oxygen or energy.',
  '彈射初速 +10%，武器傷害 +3%。': 'Launch speed +10%; weapon damage +3%.',
  '彈射與武器能量消耗各 -5%。': 'Launch and weapon energy costs -5%.',
  '生命恢復 +12%，補充資源時額外恢復 3% 生命。': 'Health recovery +12%; restore 3% extra health from resources.',
  '受到的傷害 -5%。': 'Incoming damage -5%.', '最大氧氣 +10%，氧氣倒數速度 -5%。': 'Maximum oxygen +10%; oxygen countdown speed -5%.',
  '受到的傷害 -6%，生命恢復 +8%。': 'Incoming damage -6%; health recovery +8%.',
  '最大氧氣 +12%，武器能量消耗 -4%。': 'Maximum oxygen +12%; weapon energy cost -4%.',
  '武器傷害 +10%，受到的傷害 -4%。': 'Weapon damage +10%; incoming damage -4%.',
