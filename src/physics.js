...
export const OXYGEN_STARVATION_DAMAGE_BASE_PER_SECOND = 12;
export const OXYGEN_STARVATION_DAMAGE_MULTIPLIER = 3;
export const OXYGEN_STARVATION_DAMAGE_PER_SECOND = OXYGEN_STARVATION_DAMAGE_BASE_PER_SECOND * OXYGEN_STARVATION_DAMAGE_MULTIPLIER;
...
export function stepPhysics({ map, chapter = 'chapter1', actor, dt = FIXED_STEP, origin, bounds = WORLD_BOUNDS, mutateMap = true, time = null, gravityDirection = null, zeroGravity = false }) {
  ...
  if (Math.hypot(actor.vx, actor.vy) > 3) actor.blockedResting = false;
